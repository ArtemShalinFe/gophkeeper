...
func (m *MockRecordStorage) AddRecord(ctx context.Context, userID string, record *models.RecordDTO) (*models.Record, error) {
	m.ctrl.T.Helper()
...
func (m *MockRecordStorage) GetRecord(ctx context.Context, userID, recordID string) (*models.Record, error) {
	m.ctrl.T.Helper()
...
func (m *MockRecordStorage) ListRecords(ctx context.Context, userID string, offset, limit int) ([]*models.Record, error) {
	m.ctrl.T.Helper()
...
func (m *MockRecordStorage) UpdateRecord(ctx context.Context, userID string, record *models.Record) (*models.Record, error) {
	m.ctrl.T.Helper()
